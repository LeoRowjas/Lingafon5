            ...
            <div className={styles.formBg}>
                <div className={styles.formContainer}>
                    ...
                    <div className={styles.form}>
                        <InputReg type='text' placeholder='Александр'/> 
                        <InputReg type='text' placeholder='Пушкин'/> 
                        <span className={styles.grid}>
                    ...
                    <div className={styles.formGrid}>
                        ...
                        <p>Пароль</p>
                        <InputReg type='text' placeholder='Почта'icon={<PiAtThin size={20} />}/> 
                        <InputReg type='password' placeholder='Создайте надежный пароль' icon={<PiAtThin size={20} />}/> 
                    ...
                    <ButtonReg text="Зарегистрироваться" onClick={() => alert('Registered!')} />
